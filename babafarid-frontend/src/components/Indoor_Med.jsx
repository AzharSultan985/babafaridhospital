        ...
        <div className="bg-white p-8 w-full h-screen flex flex-col">
          ...
          <div className="w-full flex justify-end bg-white z-20 sticky top-0 py-3 shadow-sm">
            <h1 className="text-2xl mr-4">
              {startDate} <span className="text-3xl font-bold">To</span> {EndDate}
            </h1>
            ...
            <form className="w-40 cursor-pointer">
              <select
                id="months"
                onChange={(e) => FetchMedicine(e.target.value)}
                className="bg-gray-50 border cursor-pointer border-gray-300 text-gray-900 text-sm rounded-lg 
