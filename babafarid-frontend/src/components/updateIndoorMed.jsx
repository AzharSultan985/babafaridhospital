...
export default function UpdateStockIndoor() {
  const {  setListOFNewstack,Updatestock_Indoor,  FetchcurrentMonthIndoorMed,
  currentMonthindoorMed } = useContext(AppContext);
//console.log("currentMonthindoorMed",currentMonthindoorMed);
  ...
  <table className="w-full text-gray-700">
          ...
          <tbody>
            {Array.isArray(currentMonthindoorMed) && currentMonthindoorMed.length > 0 ? (
              currentMonthindoorMed.map((data, index) => (
                <tr
                  key={data._id || index}
